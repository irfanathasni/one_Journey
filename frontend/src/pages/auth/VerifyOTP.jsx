...
const VerifyOTP = () => {
    ...
    return(
      ...
      <div style={styles.card}>
        ...
        {resendMessage && <div style={styles.successBox}>{resendMessage}</div>}
        <button type="button" onClick={handleResend} disabled={resendLoading}
        style={{...styles.button,background:"transparent" , color:"#c97B84", border: "1px solid #C97B84", marginTop: "10px" }}>
            {resendLoading ? "Sending..." : "Resend OTP"}</button>
      </div>
    </div>
  )
}
const styles = {
  ...
  button: {
    marginTop: "8px",
    padding: "11px", background: "#3D5A50",
    color: "#FFFFFF",
    border: "none",
    borderRadius: "6px",
    fontSize: "15px",
